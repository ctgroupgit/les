...
with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as s:
    ...
    s.sendall(b'\x00\x00\x00\x8dRUN\x00C:\\Programme\\Microsoft Office\\OFFICE11\\msaccess.exe \\\\10.76.139.20\\Berichtsgenerator\\bgeeke.mdb /cmd /home/andrea/Downloads/bgeane032.txt\x00')
    data = s.recv(1024)
