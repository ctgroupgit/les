    ...
    data.forEach( (row) => {
      switch (row[1]) {
        ...
        case 'KOPF': {
          ...
          docClass.dh1.title = row[19].trim().substr(0, 14).concat('.');
          docClass.dh1.description = row[20].trim();
          docClass.dh2.title = row[17].trim().substr(0, 14).concat('.');
          docClass.dh2.description = row[18].trim();
          docClass.dh3.title = row[15].trim().substr(0, 14).concat('.');
        ...
        case 'KOPF_DATEN': {
          ...
          docClass.dh6.title = row[18].trim().substr(0, 14).concat('.');
          docClass.dh6.description = row[20].trim();
        ...
        case 'KOPF_DATEN2': {
          ...
          docClass.dh4.title = row[17].trim().substr(0, 14).concat('.');
          docClass.dh4.description = row[16].trim();
          docClass.dh5.title = row[18].trim().substr(0, 14).concat('.');
